...
func (c *greetServiceClient) Greet(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greetpb.GreetService/Greet", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greetServiceGreetClient) CloseAndRecv() (*LongGreetResponse, error) {
...
func (x *greetServiceGreetServer) SendAndClose(m *LongGreetResponse) error {
